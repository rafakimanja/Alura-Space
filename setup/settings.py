...
STATICFILES_DIRS = [ #Indicando para o Django onde todos os arquivos estáticos estarão
    os.path.join(BASE_DIR, 'setup/static')
]

STATIC_ROOT = os.path.join(BASE_DIR, 'static') 
#caminho absoluto do diretório onde o Python vai coletar os arquivos
